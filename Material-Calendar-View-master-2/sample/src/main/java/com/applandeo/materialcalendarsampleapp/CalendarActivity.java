...
public class CalendarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        events.add(0,new EventDay(calendar, DrawableUtils.getCircleDrawableWithText(this, "✅")));
        ...
        calendar3.add(Calendar.DAY_OF_MONTH, 16);
        ...
        calendarView.setOnDayClickListener(new OnDayClickListener() {
            ...
            public void onDayClick(EventDay eventDay) {
                ...
                calendar5.add(Calendar.DAY_OF_MONTH, 14);

                events.add(new EventDay(calendar5, DrawableUtils.getCircleDrawableWithText(CalendarActivity.this, "✅")));
Toast.makeText(getApplicationContext(), "sdf"+eventDay,Toast.LENGTH_SHORT).show();
                calendarView.setEvents(events);
...
//        calendar5.add(Calendar.DAY_OF_MONTH, 14),
//
//        events.add(new EventDay(calendar5, DrawableUtils.getCircleDrawableWithText(this, "✅"))););
